package br.com.fctecno.craftbeer.api.exceptionhandler;
...
import br.com.fctecno.craftbeer.domain.exception.ValidacaoException;
...
public class BeerExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleFalha(ValidacaoException ex, WebRequest request) {
		HttpStatus status = HttpStatus.BAD_REQUEST;
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		List<Falha.Campo> campos = new ArrayList<Falha.Campo>();
